...
public:
  static const struct lexor_keyword *check_identifier (const char *str, unsigned int len);
};

inline unsigned int
Lkwd::keyword_hash (register const char *str, register unsigned int len)
{
...
Lkwd::check_identifier (register const char *str, register unsigned int len)
{
