...
public:
    ...
    inline bool empty_statements() const
    {
        return !statements_ || statements_->empty();
    }
    ...
    const SubprogramHeader *header() const
    {
        return header_;
    }
...
public:
    ...
    inline const Package *get_package() const
    {
        return package_;
    }
    ...
    virtual bool is_std() const
    {
        return false;
    }


    inline SubprogramBody *body() const
    {
        return body_;
    }
    ...
    int elaborate()
    {
        return(body_ ? body_->elaborate() : 0);
    }
